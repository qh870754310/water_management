/*
package com.qh.water_management.modules.utils;

import com.qh.water_management.modules.common.common.RRException;
import com.qh.water_management.modules.common.utils.DateUtils;
import com.qh.water_management.modules.common.utils.Utils;
import com.qh.water_management.modules.entity.generator.ColumnEntity;
import com.qh.water_management.modules.entity.generator.TableEntity;
...
/**
    ...
    public static void generatorCode(Map<String, String> table, List<Map<String, String>> columns, ZipOutputStream zip, int genType) {
        ...
        for(String template : templates){
            ...
            //本地项目生成
            if(genType == com.qh.modules.common.common.Constant.genType.local.getValue()){
                local(template,tableEntity,tpl,context);
            }
            //web页面生成
            if(genType == com.qh.modules.common.common.Constant.genType.webDown.getValue()){
                try {
                    System.out.println("==========");
