...
function bindMenuClickEvent(a, b) {
    var c = $(b.extend), d = {};
    c.length > 0 && (d = getOptionsJson(c)), b = $.extend(!0, d, b);
    var e = {};
...
function importHandler(a) {
    ...
    if ("object" == typeof b.grid) {
        ...
        c += "<tr>", c += '<td width="450"><input type="text" class="importFilePath" name="filePath"></td>', c += '<td width="100"><button type="button" class="layui-btn layui-btn-sm" id="importUpBtn"><i class="layui-icon"></i>上传文件</button></td>', c += "</td>", c += "</tr>", c += "</table>";
        var d = {
            dialog: {
                id: "importDialog",
                title: "数据导入",
        ...
        e += '<div id="importDialog-buttons" style="display:none">', e += '<a href="#" id="submitImportForm" data-toggle="topjui-linkbutton" data-options="iconCls:\'fa fa-check-circle\'">开始导入</a>', e += '<a href="#" id="closeImportDialog" data-toggle="topjui-linkbutton" data-options="btnCls:\'topjui-btn-red\'">关闭</a>', e += "</div>", $("body").append(e);
        var f = $("#" + b.dialog.id);
        f.dialog(b.dialog);
        var g = $(".importFilePath");
        g.textbox({width: 450, readonly: !0}), layui.use("upload", function () {
            var a = layui.upload;
            a.render({
                elem: "#importUpBtn", url: b.uploadUrl, accept: "file", before: function (a) {
                    layer.load()
                }, done: function (a, b, c) {
                    a.statusCode == topJUI.config.statusCode.success ? g.textbox("setValue", a.filePath) : layer.msg(a.msg, {icon: 5}), layer.closeAll("loading")
                }, error: function () {
            ...
            onClick: function () {
                var a = $("#" + b.dialog.id).serialize(), c = getColumnsNameAndField(b.grid.type, b.grid.id), d = {};
                d.ajaxData = a + "&colName=" + c.colName + "&fieldName=" + c.fieldName, d.url = b.url;
                var e = doAjax(d);
                e.statusCode == topJUI.config.statusCode.success && ($("#" + b.dialog.id).dialog("close"), refreshGrid(b.grid.type, b.grid.id)), showMessage(e)
            }
...
!function (a) {
    a.easyui = {
        ...
        a._boxModel = 100 != b.outerWidth(), b.remove(), b = a('<div style="position:fixed"></div>').appendTo("body"), a._positionFixed = "fixed" == b.css("position"), b.remove(), !window.easyloader && a.parser.auto && a.parser.parse()
    ...
    a.fn.linkbutton = function (d, e) {
        return "string" == typeof d ? a.fn.linkbutton.methods[d](this, e) : (d = d || {}, this.each(function () {
            ...
            e ? a.extend(e.options, d) : (a.data(this, "linkbutton", {options: a.extend({}, a.fn.linkbutton.defaults, a.fn.linkbutton.parseOptions(this), d)}), a(this).removeAttr("disabled"), a(this).bind("_resize", function (c, d) {
    ...
    function M(b, c) {
        ...
        if (0 != d.onBeforeEdit.call(b, e)) {
            ...
            h.val(e.text).focus(), h.width(g + 20), h._outerHeight(18), h.bind("click", function (a) {
                return !1
        ...
        render: function (b, c, d) {
            function e(c, d) {
                for (var h = [], j = 0; j < d.length; j++) {
                    var k = d[j];
                    "open" != k.state && "closed" != k.state && (k.state = "open"), k.domId = "_easyui_tree_" + Q++, h.push("<li>"), h.push('<div id="' + k.domId + '" class="tree-node">');
    ...
    function e(b) {
        function c(c) {
            ...
            switch (e.position) {
                case"right":
                    d += j._outerWidth() + 12 + (e.trackMouse ? 12 : 0), g -= (f._outerHeight() - j._outerHeight()) / 2;
                    break;
                case"left":
                    d -= f._outerWidth() + 12 + (e.trackMouse ? 12 : 0), g -= (f._outerHeight() - j._outerHeight()) / 2;
                    break;
                case"top":
    ...
    function setSize(a, b) {
        ...
        if (b && $.extend(d, {
            ...
            g._size("minHeight", j ? j - l : ""), g._size("maxHeight", k ? k - l : "")
        } else if (i) {
            if (d.header) var m = $(d.header)._outerWidth(); else {
                f.css("width", "");
                var m = f._outerWidth()
            }
            ...
            var o = e.height();
            f._outerWidth(m)._outerHeight(o), n._outerWidth(f.height()), g._outerWidth(e.width() - m - h._outerWidth())._outerHeight(o), h._outerHeight(o), g.css({
                left: "",
                right: ""
            }).css(d.halign, f.position()[d.halign] + m + "px"), d.panelCssWidth = e.css("width"), d.collapsed && e._outerWidth(m + h._outerWidth())
    ...
    function openPanel(a, b) {
        function c() {
            ...
            b.length && (d.maximized = !0), d.onOpen.call(a), 1 == d.maximized && (d.maximized = !1, maximizePanel(a)), 1 == d.collapsed && (d.collapsed = !1, collapsePanel(a)), d.collapsed || (loadData(a), doLayout(a))
        }
    ...
    function setScrollers(a) {
        ...
        if ("left" != b.tabPosition && "right" != b.tabPosition && b.showHeader) {
            var c = $(a).children("div.tabs-header"), d = c.children("div.tabs-tool:not(.tabs-tool-hidden)"),
                ...
                g = c.children("div.tabs-wrap"), h = c.outerHeight();
            ...
            i > j ? (e.add(f).show()._outerHeight(h), "left" == b.toolPosition ? (d.css({
                ...
                left: 0,
                right: ""
            }), g.css({marginLeft: d._outerWidth(), marginRight: 0, width: j})) : (d.css({
                left: "",
                right: 0
            }), g.css({marginLeft: 0, marginRight: d._outerWidth(), width: j})))
        }
    }
    ...
    function updateTab(a, b) {
        ...
        if ($.extend(e, b.options, {iconCls: b.options.icon ? b.options.icon : void 0}), "all" != b.type && "body" != b.type || d.panel(), "all" == b.type || "header" == b.type) {
            var g = e.tab;
                ...
                if (h.html(e.title), i.attr("class", "tabs-icon"), g.find("a.tabs-close").remove(), e.closable ? (h.addClass("tabs-closable"), $('<a href="javascript:;" class="tabs-close"></a>').appendTo(g)) : h.removeClass("tabs-closable"), e.iconCls ? (h.addClass("tabs-with-icon"), i.addClass(e.iconCls)) : h.removeClass("tabs-with-icon"), e.tools) {
                    ...
                    if ($.isArray(e.tools)) {
                        ...
                        for (var k = 0; k < e.tools.length; k++) {
                            ...
                            l.addClass(e.tools[k].iconCls), e.tools[k].handler && l.bind("click", {handler: e.tools[k].handler}, function (a) {
                    ...
                    e.closable ? (m += 8, j.css("right", "")) : (m -= 3, j.css("right", "5px")), h.css("padding-right", m + "px")
                } else g.find("span.tabs-p-tool").remove(), h.css("padding-right", "")
            }
            if (f != e.title) for (var k = 0; k < c.length; k++) c[k] == f && (c[k] = e.title)
        }
        e.disabled ? e.tab.addClass("tabs-disabled") : e.tab.removeClass("tabs-disabled"), setSize(a), $.data(a, "tabs").options.onUpdate.call(a, e.title, getTabIndex(a, d))
    }
            ...
            if (!j[n]) {
                ...
                m.expandMode ? o.bind("click", function () {
                    if ("dock" == m.expandMode) g(b, c); else {
                        ...
                        var d = i();
                        l.panel("resize", d.collapse), l.panel("panel").animate(d.expand, function () {
                            a(this).unbind(".layout").bind("mouseleave.layout", {region: c}, function (c) {
    ...
    a.fn.menubutton = function (d, e) {
        ...
        return d = d || {}, this.each(function () {
            ...
            e ? a.extend(e.options, d) : (a.data(this, "menubutton", {options: a.extend({}, a.fn.menubutton.defaults, a.fn.menubutton.parseOptions(this), d)}), a(this).removeAttr("disabled")), b(this), c(this)
        })
    ...
    function setDisabled(a, b) {
        ...
        void 0 != b && (c.disabled = b), c.disabled ? $(a).addClass("validatebox-disabled").attr("disabled", "disabled") : $(a).removeClass("validatebox-disabled").removeAttr("disabled")
    }

    function setReadonly(a, b) {
        var c = $.data(a, "validatebox").options;
        c.readonly = void 0 == b || b, c.readonly || !c.editable ? ($(a).triggerHandler("blur.validatebox"), $(a).addClass("validatebox-readonly").attr("readonly", "readonly")) : $(a).removeClass("validatebox-readonly").removeAttr("readonly")
    }
    ...
    function g(b) {
        ...
        if (g.attr("placeholder", d.prompt), g.unbind(".textbox"), a(c.label).unbind(".textbox"), !d.disabled && !d.readonly) {
            c.label && a(c.label).bind("click.textbox", function (c) {
                ...
                d.hasFocusMe = !0, f.hasClass("textbox-focused") || (a(this).val() != d.value && a(this).val(d.value), a(this).removeClass("textbox-prompt"), f.addClass("textbox-focused"))
            });
    ...
    function h(b, c) {
        ...
        e.disabled = c, e.disabled ? (g.blur(), g.validatebox("disable"), f.addClass("textbox-disabled"), h.attr("disabled", "disabled"), a(d.label).addClass("textbox-label-disabled")) : (g.validatebox("enable"), f.removeClass("textbox-disabled"), h.removeAttr("disabled"), a(d.label).removeClass("textbox-label-disabled"))
    }
    ...
    a.fn.textbox = function (d, f) {
        ...
        options: function (b) {
            ...
            return b.each(function () {
                ...
                c = void 0 == c ? "" : String(c), a(this).textbox("getText") != c && d.val(c), b.value = c, d.is(":focus") || (c ? d.removeClass("textbox-prompt") : d.val(b.prompt).addClass("textbox-prompt")), a(this).textbox("validate")
            })
    ...
    function b(b) {
        ...
        h.length && (a('<label class="filebox-label" for="' + f.fileboxId + '"></label>').appendTo(h),
        ...
        options: function (a) {
            ...
            return a.each(function () {
                ...
                a && a.children("div.menu-item").each(function () {
                    ...
                    if (c.name == b) return $(this).triggerHandler("click"), !1
                })
            })
        }, destroy: function (a) {
            return a.each(function () {
    ...
    function b(b, e) {
        ...
        if (0 != f.onSubmit.call(b, g)) {
            ...
            f.ajax ? f.iframe ? c(b, g) : void 0 !== window.FormData ? d(b, g) : c(b, g) : a(b).submit(), f.dirty && i.removeAttr("disabled")
        }
    }
    ...
    function b(b) {
        ...
        if ("left" == e.spinAlign || "right" == e.spinAlign) {
            ...
            var g = {
                iconCls: "spinner-arrow", handler: function (b) {
        ...
        if (a(b).addClass("spinner-f").textbox(a.extend({}, e, {
            ...
            h.append('<a href="javascript:;" class="spinner-arrow-up" tabindex="-1"></a>'), h.append('<a href="javascript:;" class="spinner-arrow-down" tabindex="-1"></a>')
        } else {
    ...
    function fixRowHeight(a, b, c) {
        ...
        if (setBodySize(a), "auto" == f.height) {
            ...
            l.width > k.width() && (m += 18), m -= parseInt(k.css("marginTop")) || 0, j.height(m), k.height(m), g.view.height(g.view2.height())
        }
    ...
    function scrollTo(a, b) {
        ...
        if (f.length) {
            ...
            var j = h.outerHeight(!0) - h.outerHeight(), k = f.position().top - g - j;
    ...
    function request(a, b, c) {
        ...
        var f = d.loader.call(a, e, function (b) {
            ...
            b.total / d.pageSize > 4 && (d.pageNumber -= 1), e.pagination("refresh", {
                pageNumber: d.pageNumber,
                total: b.total
            }), c && c()
        }, function () {
        ...
        render: function (b, c, d) {
            ...
            for (var j = 0; j < c.length; j++) {
                ...
                if (l) {
                    ...
                    var p = "";
                    if (l.checkbox || (l.align && (p += "text-align:" + l.align + ";"), h.nowrap ? h.autoRowHeight && (p += "height:auto;") : p += "white-space:normal;height:auto;"), i.push('<div style="' + p + '" '), l.checkbox ? i.push('class="datagrid-cell-check ') : i.push('class="datagrid-cell ' + l.cellClass), i.push('">'), l.checkbox) f.checked ? i.push('<input type="checkbox" checked="checked"') : i.push('<input type="checkbox"'), i.push(' name="' + k + '" value="' + (void 0 != f[k] ? f[k] : "") + '">'); else {
                        var q = null;
    ...
    function o(b) {
        ...
        c.onChange = function () {
        }, c.multiple ? l(b, c.value ? c.value : []) : n(b, c.value), c.onChange = d
    }
    ...
    a(function () {
        ...
        return c = c || {}, this.each(function () {
            ...
            d ? (a.extend(d.options, c), void 0 != c.value && (d.options.originalValue = c.value)) : (d = a.data(this, "combo", {
                ...
                previousText: ""
            }), d.options.multiple && "" == d.options.value ? d.options.originalValue = [] : d.options.originalValue = d.options.value), b(this), o(this)
        })
    }, a.fn.combo.methods = {
        options: function (b) {
            var c = b.textbox("options");
    ...
    function g(b, c, d) {
        ...
        a.isArray(c) || (c = c.split(e.separator)), e.multiple || (c = c.length ? [c[0]] : [""]);
        ...
        for (var h = null, i = [], j = [], k = 0; k < c.length; k++) {
            var l = c[k], m = l, n = e.finder.getRow(b, l);
            if (n) {
                m = n[e.textField], h = n;
        ...
        if (d || a(b).combo("setText", j.join(e.separator)), e.showItemIcon) {
            ...
            p.removeClass("textbox-bgicon " + e.textboxIconCls), h && h.iconCls && (p.addClass("textbox-bgicon " + h.iconCls), e.textboxIconCls = h.iconCls)
        }
        a(b).combo("setValues", i), f.triggerHandler("scroll")
    }
    ...
    function l(b) {
        ...
        e.unbind(".combobox");
        for (var f in d.panelEvents) e.bind(f + ".combobox", {target: b}, d.panelEvents[f])
    }
    ...
    a.fn.combobox.defaults = a.extend({}, a.fn.combo.defaults, {
        ...
        panelEvents: {mouseover: m, mouseout: n, click: o, scroll: p},
        filter: function (b, c) {
    ...
    function b(b) {
        ...
        a(b).addClass("tagbox-f").combobox(a.extend({}, g, {
            cls: "tagbox", reversed: !0, onChange: function (c, e) {
                ...
                var h = a(this).combobox("textbox"), i = a(this).data("textbox").textbox;
                i.css({
                    height: "",
                    paddingLeft: h.css("marginLeft"),
                    paddingRight: h.css("marginRight")
                }), h.css("margin", 0), i._size({width: g.width}, a(this).parent()), e(b), c(this), g.onResizing.call(b, d, f)
            }, onLoadSuccess: function (a) {
        ...
        if (a(b).addClass("datebox-f").combo(a.extend({}, h, {
            ...
            a.extend(g.calendar.calendar("options"), {
                fit: !0, border: !1, onSelect: function (b) {
                    ...
                    e(c, d.formatter.call(c, b)), a(c).combo("hidePanel"), d.onSelect.call(c, b)
                }
            })
        }
    ...
    function buildSlider(a) {
        function b(b, c) {
            var e = pos2value(a, b), f = Math.abs(e % d.step);
            if (f < d.step / 2 ? e -= f : e = e - f + d.step, d.range) {
                var g = d.value[0], h = d.value[1], i = parseFloat((g + h) / 2);
                if (c) {
        ...
        var c = $.data(a, "slider"), d = c.options, e = c.slider;
        e.removeClass("slider-h slider-v slider-disabled"), e.addClass("h" == d.mode ? "slider-h" : "slider-v"), e.addClass(d.disabled ? "slider-disabled" : "");
        var f = e.find(".slider-inner");
        f.html('<a href="javascript:;" class="slider-handle"></a><span class="slider-tip"></span>'), d.range && f.append('<a href="javascript:;" class="slider-handle"></a><span class="slider-tip"></span>'), e.find("a.slider-handle").draggable({
            axis: d.mode,
            cursor: "pointer",
            disabled: d.disabled,
            onDrag: function (a) {
                var c = a.data.left, f = e.width();
                return "h" != d.mode && (c = a.data.top, f = e.height()), !(c < 0 || c > f) && (b(c, this), !1)
            },
            onStartDrag: function () {
                c.isDragging = !0, d.onSlideStart.call(a, d.value)
            },
            onStopDrag: function (e) {
                b("h" == d.mode ? e.data.left : e.data.top, this), d.onSlideEnd.call(a, d.value), d.onComplete.call(a, d.value), c.isDragging = !1
            }
        }), e.find("div.slider-inner").unbind(".slider").bind("mousedown.slider", function (e) {
            if (!c.isDragging && !d.disabled) {
                var f = $(this).offset();
                b("h" == d.mode ? e.pageX - f.left : e.pageY - f.top), d.onComplete.call(a, d.value)
            }
        })
    }
    ...
    function value2pos(a, b) {
        ...
        return "v" == d.mode && (g = e.height() - g), d.reversed && (g = f - g), g.toFixed(0)
    }
...
var c = function () {
        $.fn.combobox.defaults = {}, $.fn.datebox.defaults = {}
    }, scripts = document.getElementsByTagName("script"), lastScript = scripts[scripts.length - 1],
...
var openDialog = function (a) {
    ...
    if ("object" == typeof d) openDialogAndloadDataByParentGrid(b); else if (c.url) openDialogAndloadDataByUrl(b); else {
        ...
        if (topJUI.config.appendRefererParam && (b.dialog.href = appendSourceUrlParam(b.dialog.href)), b.dialog.href.indexOf("{") != -1) {
            var g = b.dialog.href, h = b.grid.unselectedMsg || b.grid.uncheckedMsg,
                f = getSelectedRowsData(b.grid.type, b.grid.id);
            if (!f[0]) return void topjuiAlert(h || topJUI.language.message.msg.unSelect);
            if (1 != f.length) return void topjuiAlert(topJUI.language.message.msg.singleSelect);
            c.href = replaceUrlParamValueByBrace(b.dialog.href, f[0]), $("#" + c.id).iDialog("openDialog", c), b.dialog.href = g
        } else $("#" + c.id).iDialog("openDialog", b.dialog)
    }
}, addParentTab = function (a) {
    var b, c, d = $.data(a, "menubutton").options, e = d.tab;
    ...
    var i = '<iframe src="' + b + '" frameborder="0" style="border:0;width:100%;height:100%;"></iframe>',
        j = parent.$("#index_tabs"), k = getSelectedTabOpts(j);
    j.iTabs("add", {
...
$.fn.serializeObject = function () {
    ...
    a.fn.datagrid.defaults.onHeaderContextMenu = b, a.fn.treegrid.defaults.onHeaderContextMenu = b, a.fn.iDatagrid = function (b, c) {
        ...
        loadFilter: function (a) {
            var b = {};
            return b.total = a[topJUI.config.datagrid.total] ? a[topJUI.config.datagrid.total] : a.length, b.rows = a[topJUI.config.datagrid.rows] ? a[topJUI.config.datagrid.rows] : a, b
        },
        onLoadSuccess: function () {
    ...
    function b(b, c) {
        ...
        if ("object" == typeof c.buttonsGroup) {
            ...
            a.each(h, function (a, b) {
                b.handler || (b.handler = "ajaxForm"), void 0 == b.id && g.push(getRandomNumByDef()), f += '<a id="' + g[a] + '" href="#" data-options="mbId:\'' + c.mbId + "',dialogId:'" + c.id + "'\">" + b.text + "</a>"
            })
        }
    ...
    a.fn.iDialog = function (b, c) {
        ...
        onLoad: function () {
            ...
            if (b.mbId) {
                var c = a("#" + b.id), d = a("#" + b.mbId).iMenubutton("options");
    ...
    a.fn.iLayout = function (b, c) {
        ...
        this.each(function () {
            b = a.fn.iLayout.parseOptions(this, b), a(this).layout(b)
        })
            ...
            if ("object" == typeof b.form) {
                ...
                if (arrayContain(d, b.handler)) {
                    if ("ajaxForm" == b.handler || "multiAjaxForm" == b.handler) {
                        ...
                        var e = a("#" + b.mbId).menubutton("options"), f = {reload: !0},
                            g = a.extend(a("#" + e.grid.id)[e.grid.type]("options"), f, e.grid);
                        e.dialog;
                        if (a("#" + b.dialogId).form("validate")) {
                            if (b.ajaxData = a("#" + b.dialogId).serialize(), "multiAjaxForm" == b.handler) {
                                var h = getCheckedRowsData(g.type, g.id);
                                void 0 == g.param && (g.param = topJUI.config.pkName + ":" + topJUI.config.pkName), b.ajaxData += "&" + convertParamObj2Serialize(param2JsonObj(g.param), h)
                            }
                            var i = doAjax(b);
                            if (i.statusCode == topJUI.config.statusCode.success) {
                                if (a("#" + b.dialogId).dialog("close"), "object" == typeof g && 1 == g.reload) if ("datagrid" == g.type) a("#" + g.id).datagrid("reload"); else if ("treegrid" == g.type) {
                                    var j = getSelectedRowData(g.type, g.id), k = a("#" + g.id).treegrid("getRoots"),
                                        l = !1;
                                    if (null != j && null != k) for (var m = 0; m < k.length; m++) if (k[m][g.idField] == j[g.idField]) {
                                        l = !0;
                                        break
                                    }
                                    null == j || 1 == l ? a("#" + g.id).treegrid("reload") : a("#" + g.id).treegrid("reload", j[g.parentIdField])
                                }
    ...
    a.fn.iMenubutton = function (b, c) {
        ...
        this.each(function () {
            b = a.fn.iMenubutton.parseOptions(this, b), b = bindMenuClickEvent(a(this), b), b.text = "" == b.text ? a(this).text() : b.text, a(this).menubutton(b)
        })
        ...
        plain: !0, iconCls: "fa fa-cog", hasDownArrow: !1, onClick: function () {
